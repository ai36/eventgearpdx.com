...
- [ ] https://eventgearpdx.com/blog/questions-to-ask-av-company-before-event — пункт 11, новый адрес
- [ ] https://eventgearpdx.com/blog/guide-to-evaluating-av-equipment — пункт 11
- [ ] https://eventgearpdx.com/blog/projection-equipment-presenting-guidelines — пункт 11
...
## Переработка контента блога — завершена

Все 11 пунктов выполнены 23.09.2026: 88 статей → 32, 59 перенаправлений (301),
ложные обещания убраны везде. Подробности по пунктам — в `CHANGELOG.md`,
исходная раскладка — в [docs/content-restructure-plan.md](docs/content-restructure-plan.md).
Порядок выполнения пункта сохранён там же, в раскладке, если переработка понадобится снова.
