...
export function CookieBanner() {
  ...
  return (
    <section className="fixed bottom-0 p-8 bg-background text-foreground z-9999 shadow-lg border border-border">
      <h2 className="font-display text-2xl font-semibold text-foreground mb-4">
        We value your privacy
      </h2>
      <p className="font-display text-md text-foreground mb-6">
        We use cookies and similar technologies to collect aggregated analytics
        data that helps us understand how the site is used and improve its
        performance and user experience. Analytics data may be collected through
      ...
      <div className="flex gap-2 justify-end">
        <button
          ...
          onClick={() => {
            ...
            setVisible(false);
            // Сообщаем AnalyticsGate, чтобы он подгрузил GA сразу
