...
const Footer = () => {
  return (
    <>
      <footer className="py-12 bg-primary text-primary-foreground dark:bg-black/40 dark:text-muted-foreground">
        <div className="container mx-auto px-6">
          ...
          <div className="border-t border-primary-foreground/10 dark:border-muted-foreground/20 mt-10 pt-6 text-center text-xs text-primary-foreground/40 dark:text-muted-foreground/40">
